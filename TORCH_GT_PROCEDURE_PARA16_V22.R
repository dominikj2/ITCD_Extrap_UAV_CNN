...
################################
# FIRST BOUNDING BOX CALCULATION
################################
...
# TID LOCATION (base)
#####################
X_oneT_oneS <- mean(LAS_UAS_Thin_oneT$X[which.min(LAS_UAS_Thin_oneT$Z)])
Y_oneT_oneS <- mean(LAS_UAS_Thin_oneT$Y[which.min(LAS_UAS_Thin_oneT$Z)])
Z_oneT_oneS <- mean(LAS_UAS_Thin_oneT$Z[which.min(LAS_UAS_Thin_oneT$Z)])
